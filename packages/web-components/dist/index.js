...
function ContextProvider(props) {
  ...
  return (0, import_preact.cloneElement)(children, rest);
}
function connectedCallback() {
  ...
  this._vdom = (0, import_preact.h)(
    ContextProvider,
    { ...this._props, context },
    toVdom(this, this._vdomComponent)
  );
  (this.hasAttribute("hydrate") ? import_preact.hydrate : import_preact.render)(this._vdom, this._root);
}
...
function attributeChangedCallback(name, oldValue, newValue) {
  ...
  this._vdom = (0, import_preact.cloneElement)(this._vdom, props);
  (0, import_preact.render)(this._vdom, this._root);
}
function disconnectedCallback() {
  (0, import_preact.render)(this._vdom = null, this._root);
}
function Slot(props, context) {
  ...
  return (0, import_preact.h)("slot", { ...props, ref });
}
function toVdom(element, nodeName) {
  ...
  for (i = cn.length; i--; ) {
    ...
    if (name) {
      props[name] = (0, import_preact.h)(Slot, { name }, vnode);
    } else {
      children[i] = vnode;
    }
  }
  const wrappedChildren = nodeName ? (0, import_preact.h)(Slot, null, children) : children;
  return (0, import_preact.h)(nodeName || element.nodeName.toLowerCase(), props, wrappedChildren);
}
...
(0, import_core.initializeComponents)(import_preact2.h, createComponent);
